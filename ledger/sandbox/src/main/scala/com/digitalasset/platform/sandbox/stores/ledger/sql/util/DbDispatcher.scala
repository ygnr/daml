...
import com.digitalasset.platform.sandbox.stores.ledger.sql.dao.{HikariJdbcConnectionProvider, JdbcLedgerDao}
...
private class DbDispatcherImpl(
  ...
  private val connectionProvider =
    HikariJdbcConnectionProvider(jdbcUrl, dbType, noOfShortLivedConnections, noOfStreamingConnections)
